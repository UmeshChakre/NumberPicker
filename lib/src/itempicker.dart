...
class ItemPicker extends StatefulWidget {
  ...
  @override
  _ItemPickerStateState createState() => _ItemPickerStateState();
}

class _ItemPickerStateState extends State<ItemPicker> {
  late ScrollController _scrollController;

  @override
  void initState() {
    super.initState();
    final initialOffset = (widget.selectedIndex) ~/ widget.step * itemExtent;
  ...
  void _scrollListener() {
    ...
    if (widget.selectedIndex != intValueInTheMiddle) {
  ...
  @override
  void didUpdateWidget(ItemPicker oldWidget) {
  ...
  int get itemCount => widget.itemList.length;
      ...
      child: NotificationListener<ScrollEndNotification>(
        ...
        child: Stack(
          children: [
            ...
            _ITemPickerSelectedItemDecoration(
              axis: widget.axis,
              itemExtent: itemExtent,
  ...
  Widget _itemBuilder(BuildContext context, int index) {
    ...
    final itemStyle =
        value == widget.selectedIndex ? selectedStyle : defaultStyle;
  ...
  String _getDisplayedValue(int value) {
    return widget.itemList[value].toString();
  }
...
class _ITemPickerSelectedItemDecoration extends StatelessWidget {
  final Axis axis;
  final double itemExtent;
  final Decoration? decoration;

  const _ITemPickerSelectedItemDecoration({
    Key? key,
    required this.axis,
